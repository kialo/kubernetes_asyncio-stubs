...
class CoordinationV1beta1Api:
    ...
    ) -> kubernetes_asyncio.client.V1beta1LeaseCandidateList: ...
    ...
    async def create_namespaced_lease_candidate(
        self,
        namespace: str,
        body: kubernetes_asyncio.client.V1beta1LeaseCandidate,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1beta1LeaseCandidate: ...
