...
class StorageV1alpha1Api:
    ...
    ) -> kubernetes_asyncio.client.V1alpha1VolumeAttributesClassList: ...
    async def create_volume_attributes_class(
        self,
        body: kubernetes_asyncio.client.V1alpha1VolumeAttributesClass,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1alpha1VolumeAttributesClass: ...
