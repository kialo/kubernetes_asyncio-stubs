...
class NetworkingV1Api:
    ...
    ) -> kubernetes_asyncio.client.V1IngressClassList: ...
    async def create_ingress_class(
        self,
        body: kubernetes_asyncio.client.V1IngressClass,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1IngressClass: ...
    ...
    async def list_ingress_for_all_namespaces(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1IngressList: ...
    async def list_ip_address(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1IPAddressList: ...
    async def create_ip_address(
        self,
        body: kubernetes_asyncio.client.V1IPAddress,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1IPAddress: ...
    ...
    async def create_namespaced_ingress(
        self,
        namespace: str,
        body: kubernetes_asyncio.client.V1Ingress,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
    ...
    async def list_namespaced_network_policy(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1NetworkPolicyList: ...
    async def create_namespaced_network_policy(
        self,
        namespace: str,
        body: kubernetes_asyncio.client.V1NetworkPolicy,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
    ...
    async def list_service_cidr(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1ServiceCIDRList: ...
    async def create_service_cidr(
        self,
        body: kubernetes_asyncio.client.V1ServiceCIDR,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1ServiceCIDR: ...
