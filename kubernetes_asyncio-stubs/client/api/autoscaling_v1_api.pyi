...
class AutoscalingV1Api:
    ...
    ) -> kubernetes_asyncio.client.V1HorizontalPodAutoscalerList: ...
    ...
    async def create_namespaced_horizontal_pod_autoscaler(
        self,
        namespace: str,
        body: kubernetes_asyncio.client.V1HorizontalPodAutoscaler,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1HorizontalPodAutoscaler: ...
