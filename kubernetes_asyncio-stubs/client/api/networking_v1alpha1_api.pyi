...
class NetworkingV1alpha1Api:
    ...
    ) -> kubernetes_asyncio.client.V1alpha1IPAddressList: ...
    async def create_ip_address(
        self,
        body: kubernetes_asyncio.client.V1alpha1IPAddress,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1alpha1IPAddress: ...
    ...
    async def list_service_cidr(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1alpha1ServiceCIDRList: ...
    async def create_service_cidr(
        self,
        body: kubernetes_asyncio.client.V1alpha1ServiceCIDR,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1alpha1ServiceCIDR: ...
