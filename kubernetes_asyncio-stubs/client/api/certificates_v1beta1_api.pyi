...
class CertificatesV1beta1Api:
    ...
    ) -> kubernetes_asyncio.client.V1beta1ClusterTrustBundleList: ...
    async def create_cluster_trust_bundle(
        self,
        body: kubernetes_asyncio.client.V1beta1ClusterTrustBundle,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1beta1ClusterTrustBundle: ...
