...
class AuthenticationV1Api:
    ...
    async def create_self_subject_review(
        self,
        body: kubernetes_asyncio.client.V1SelfSubjectReview,
        *,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
        pretty: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1SelfSubjectReview: ...
    async def create_token_review(
        self,
        body: kubernetes_asyncio.client.V1TokenReview,
        *,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
        pretty: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1TokenReview: ...
