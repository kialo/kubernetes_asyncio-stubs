...
class FlowcontrolApiserverV1Api:
    ...
    ) -> kubernetes_asyncio.client.V1FlowSchemaList: ...
    async def create_flow_schema(
        self,
        body: kubernetes_asyncio.client.V1FlowSchema,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1FlowSchema: ...
    ...
    async def list_priority_level_configuration(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes_asyncio.client.V1PriorityLevelConfigurationList: ...
    async def create_priority_level_configuration(
        self,
        body: kubernetes_asyncio.client.V1PriorityLevelConfiguration,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1PriorityLevelConfiguration: ...
