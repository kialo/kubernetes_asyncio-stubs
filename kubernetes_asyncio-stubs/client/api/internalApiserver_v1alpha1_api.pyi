...
class InternalApiserverV1alpha1Api:
    ...
    ) -> kubernetes_asyncio.client.V1alpha1StorageVersionList: ...
    async def create_storage_version(
        self,
        body: kubernetes_asyncio.client.V1alpha1StorageVersion,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes_asyncio.client.V1alpha1StorageVersion: ...
