...
class V2MetricStatus:
    container_resource: typing.Optional[
        kubernetes_asyncio.client.V2ContainerResourceMetricStatus
    ]
    ...
    def __init__(
        ...
        *,
        ...
        external: typing.Optional[
            kubernetes_asyncio.client.V2ExternalMetricStatus
        ] = ...,
        object: typing.Optional[kubernetes_asyncio.client.V2ObjectMetricStatus] = ...,
        pods: typing.Optional[kubernetes_asyncio.client.V2PodsMetricStatus] = ...,
        resource: typing.Optional[
            kubernetes_asyncio.client.V2ResourceMetricStatus
        ] = ...,
        type: str,
    ) -> None: ...
...
class V2MetricStatusDict(typing.TypedDict, total=False):
    containerResource: kubernetes_asyncio.client.V2ContainerResourceMetricStatusDict
    external: kubernetes_asyncio.client.V2ExternalMetricStatusDict
    object: kubernetes_asyncio.client.V2ObjectMetricStatusDict
    pods: kubernetes_asyncio.client.V2PodsMetricStatusDict
    resource: kubernetes_asyncio.client.V2ResourceMetricStatusDict
    type: str
