...
class V1NetworkPolicyIngressRule:
    ...
    def __init__(
        self,
        *,
        _from: typing.Optional[
            list[kubernetes_asyncio.client.V1NetworkPolicyPeer]
        ] = ...,
        ports: typing.Optional[
            list[kubernetes_asyncio.client.V1NetworkPolicyPort]
        ] = ...,
    ) -> None: ...
    def to_dict(self) -> V1NetworkPolicyIngressRuleDict: ...

class V1NetworkPolicyIngressRuleDict(typing.TypedDict, total=False):
    _from: list[kubernetes_asyncio.client.V1NetworkPolicyPeerDict]
