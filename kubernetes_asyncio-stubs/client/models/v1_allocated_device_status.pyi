...
class V1AllocatedDeviceStatus:
    ...
    device: str
    driver: str
    network_data: typing.Optional[kubernetes_asyncio.client.V1NetworkDeviceData]
    pool: str
    ...
    def __init__(
        ...
        *,
        ...
        network_data: typing.Optional[
            kubernetes_asyncio.client.V1NetworkDeviceData
        ] = ...,
        pool: str,
        share_id: typing.Optional[str] = ...,
    ) -> None: ...
...
class V1AllocatedDeviceStatusDict(typing.TypedDict, total=False):
    ...
    device: str
    driver: str
    networkData: kubernetes_asyncio.client.V1NetworkDeviceDataDict
    pool: str
    shareID: str
