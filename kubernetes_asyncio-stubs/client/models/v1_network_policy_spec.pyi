    ...
    def __init__(
        ...
        *,
        egress: typing.Optional[
            list[kubernetes_asyncio.client.V1NetworkPolicyEgressRule]
        ] = ...,
        ingress: typing.Optional[
            list[kubernetes_asyncio.client.V1NetworkPolicyIngressRule]
        ] = ...,
        pod_selector: kubernetes_asyncio.client.V1LabelSelector,
        policy_types: typing.Optional[list[str]] = ...,
    ) -> None: ...
...
class V1NetworkPolicySpecDict(typing.TypedDict, total=False):
    egress: list[kubernetes_asyncio.client.V1NetworkPolicyEgressRuleDict]
    ingress: list[kubernetes_asyncio.client.V1NetworkPolicyIngressRuleDict]
