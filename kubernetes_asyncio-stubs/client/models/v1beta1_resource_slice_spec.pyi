...
class V1beta1ResourceSliceSpec:
    ...
    shared_counters: typing.Optional[list[kubernetes_asyncio.client.V1beta1CounterSet]]
    ...
    def __init__(
        ...
        *,
        ...
        shared_counters: typing.Optional[
            list[kubernetes_asyncio.client.V1beta1CounterSet]
        ] = ...,
    ) -> None: ...
...
class V1beta1ResourceSliceSpecDict(typing.TypedDict, total=False):
    ...
    sharedCounters: list[kubernetes_asyncio.client.V1beta1CounterSetDict]
