...
class V1CustomResourceDefinition:
    ...
    status: kubernetes_asyncio.client.V1CustomResourceDefinitionStatus
    ...
    def __init__(
        ...
        *,
        ...
        status: typing.Optional[
            kubernetes_asyncio.client.V1CustomResourceDefinitionStatus
        ] = ...,
    ) -> None: ...
...
class V1CustomResourceDefinitionDict(typing.TypedDict, total=False):
    ...
    status: kubernetes_asyncio.client.V1CustomResourceDefinitionStatusDict
