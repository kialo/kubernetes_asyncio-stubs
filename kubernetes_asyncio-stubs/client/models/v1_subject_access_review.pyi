...
class V1SubjectAccessReview:
    ...
    status: kubernetes_asyncio.client.V1SubjectAccessReviewStatus
    ...
    def __init__(
        ...
        *,
        ...
        status: typing.Optional[
            kubernetes_asyncio.client.V1SubjectAccessReviewStatus
        ] = ...,
    ) -> None: ...
...
class V1SubjectAccessReviewDict(typing.TypedDict, total=False):
    ...
    status: kubernetes_asyncio.client.V1SubjectAccessReviewStatusDict
