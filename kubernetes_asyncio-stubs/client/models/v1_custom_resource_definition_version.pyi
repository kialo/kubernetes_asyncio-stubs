...
class V1CustomResourceDefinitionVersion:
    additional_printer_columns: typing.Optional[
        list[kubernetes_asyncio.client.V1CustomResourceColumnDefinition]
    ]
    ...
    subresources: typing.Optional[
        kubernetes_asyncio.client.V1CustomResourceSubresources
    ]
...
class V1CustomResourceDefinitionVersionDict(typing.TypedDict, total=False):
    ...
    selectableFields: list[kubernetes_asyncio.client.V1SelectableFieldDict]
    served: bool
    storage: bool
