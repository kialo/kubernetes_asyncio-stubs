...
class V1alpha2ResourceClaim:
    ...
    status: typing.Optional[kubernetes_asyncio.client.V1alpha2ResourceClaimStatus]
...
class V1alpha2ResourceClaimDict(typing.TypedDict, total=False):
    ...
    status: typing.Optional[kubernetes_asyncio.client.V1alpha2ResourceClaimStatusDict]
