...
class V1beta2ResourceClaim:
    ...
    status: kubernetes_asyncio.client.V1beta2ResourceClaimStatus
    ...
    def __init__(
        ...
        *,
        ...
        status: typing.Optional[
            kubernetes_asyncio.client.V1beta2ResourceClaimStatus
        ] = ...,
    ) -> None: ...
...
class V1beta2ResourceClaimDict(typing.TypedDict, total=False):
    ...
    status: kubernetes_asyncio.client.V1beta2ResourceClaimStatusDict
