...
class V1CSIPersistentVolumeSourceDict(typing.TypedDict, total=False):
    controllerExpandSecretRef: typing.Optional[
        kubernetes_asyncio.client.V1SecretReferenceDict
    ]
    controllerPublishSecretRef: typing.Optional[
        kubernetes_asyncio.client.V1SecretReferenceDict
    ]
    driver: str
    fsType: typing.Optional[str]
    nodeExpandSecretRef: typing.Optional[
        kubernetes_asyncio.client.V1SecretReferenceDict
    ]
    nodePublishSecretRef: typing.Optional[
        kubernetes_asyncio.client.V1SecretReferenceDict
    ]
